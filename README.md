...
window header. Themes `typesafe`, `typesafe-light`, `wafer`, and `wafer-light` are installed into `~/.reflex/agent/themes`. The web UI also offers Wafer under Settings → Look (issue #9 stays open for more community themes).
